...
describe("Create", () => {
    ...
    it("Classificacao", () => {
        ...
        expect(result[0]).to.equal(`CREATE TABLE IF NOT EXISTS Classificacao( codeImport INTEGER NOT NULL PRIMARY KEY, descricao TEXT );`);
    });
    ...
    it("Regiao", () => {
        ...
        const result = create.compile();
        expect(result[0].length > 0).to.equal(true);
        expect(result[0]).to.equal(`CREATE TABLE IF NOT EXISTS Regiao( codeImport INTEGER NOT NULL PRIMARY KEY, nome TEXT );`);
    });
    ...
    it("SubRegiao", () => {
        ...
        const result = create.compile();
        expect(result[0].length > 0).to.equal(true);
        expect(result[0]).to.equal(`CREATE TABLE IF NOT EXISTS SubRegiao( codeImport INTEGER NOT NULL PRIMARY KEY, nome TEXT, regiao_codeImport INTEGER );`);
    });
    ...
    it("CondicaoPagamento", () => {
        ...
        const result = create.compile();
        expect(result[0].length > 0).to.equal(true);
        expect(result[0]).to.equal(`CREATE TABLE IF NOT EXISTS CondicaoPagamento( codeImport INTEGER NOT NULL PRIMARY KEY, nome TEXT );`);
    });
    ...
    it("Test create", () => {
        ...
        const result = create.compile();
        expect(result[0].length > 0).to.equal(true);
        expect(result[0]).to.equal(`CREATE TABLE IF NOT EXISTS TestClazzList( internalKey INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, id INTEGER, description TEXT, reference_id INTEGER );`);
    });
    ...
    it("TestClazzRefCode", () => {
        ...
        const result = create.compile();
        expect(result[0].length > 0).to.equal(true);
        expect(result[0]).to.equal(`CREATE TABLE IF NOT EXISTS TestClazzRefCode( code TEXT NOT NULL PRIMARY KEY, description TEXT, reference_description TEXT );`);
    });
    ...
    it("LoginOffline", () => {
        ...
        const result = create.compile();
        expect(result[0].length > 0).to.equal(true);
        expect(result[0]).to.equal(`CREATE TABLE IF NOT EXISTS LoginOffline( internalKey INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, id INTEGER, hash TEXT, permissions TEXT );`);
    });
    ...
    it("Test circular references", () => {
        ...
        const result = create.compile();
        expect(result[0].length > 0).to.equal(true);
        expect(result[0]).to.equal(`CREATE TABLE IF NOT EXISTS TestClazzRef( id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, description TEXT, autoReference_id INTEGER );`);
    });
    ...
    it("GuidClazz", () => {
        ...
        const result = create.compile();
        expect(result[0].length > 0).to.equal(true);
        expect(result[0]).to.equal(`CREATE TABLE IF NOT EXISTS GuidClazz( guid TEXT NOT NULL PRIMARY KEY, description TEXT );`);
    });
    ...
    it("HeaderSimple", () => {
        ...
        // expect(result[0].length > 0).to.equal(true);
        expect(result[0]).to.equal(`CREATE TABLE IF NOT EXISTS HeaderSimple( id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, descricao TEXT );`);
        expect(result[1]).to.equal(`CREATE TABLE IF NOT EXISTS ItemHeaderSimple( indexArray INTEGER, value TEXT, HeaderSimple_id INTEGER , PRIMARY KEY (indexArray, HeaderSimple_id) );`);
    });
